...
export default function ApologeticsChat({ className = '' }: ApologeticsChatProps) {
  ...
  return (
    <div className={`min-h-screen ${isDarkTheme ? 'bg-black text-white' : 'bg-white text-black'} ${className} pt-4 md:pt-12`} style={{ backgroundColor: isDarkTheme ? '#000000' : '#ffffff' }}>
      {/* Header */}
